...
insert into produtos(nome, descricao, preco, categoria) value
...
insert into info_produtos (id_produtos, ingredientes, fornecedor) value
...
insert into pedidos(id_cliente, id_funcionarios, id_produtos, quantidade, data_pedido, status) value
...
select * from funcionarios where cpf like '444.555.666-77';
